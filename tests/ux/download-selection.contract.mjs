...
assert.deepEqual(
  resolveDownloadRequest({ search: '?download=1&platform=darwin&arch=unknown', platform: 'MacIntel', architecture: 'arm64' }),
  { autoDownload: true, hasExplicitTarget: true, url: null },
)
assert.deepEqual(
  resolveDownloadRequest({ search: '', platform: 'Win32', architecture: 'x86' }),
  { autoDownload: false, hasExplicitTarget: false, url: downloadUrls.windowsX64 },
)

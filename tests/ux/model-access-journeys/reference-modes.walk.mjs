/**
 * Model-access journey script: reference-modes
 *
 ...
 */
throw new Error(
  'reference-modes.walk.mjs is a manifest placeholder; the executable roundtrip harness lands with the model-access journeys change.',
)

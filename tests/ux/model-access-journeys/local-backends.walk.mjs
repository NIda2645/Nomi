/**
 * Model-access journey script: local-backends
 *
 ...
 */
throw new Error(
  'local-backends.walk.mjs is a manifest placeholder; the executable roundtrip harness lands with the model-access journeys change.',
)

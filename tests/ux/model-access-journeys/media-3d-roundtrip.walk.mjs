/**
 * Model-access journey script: media-3d-roundtrip
 *
 ...
 */
throw new Error(
  'media-3d-roundtrip.walk.mjs is a manifest placeholder; the executable roundtrip harness lands with the model-access journeys change.',
)

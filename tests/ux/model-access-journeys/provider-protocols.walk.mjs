/**
 * Model-access journey script: provider-protocols
 *
 ...
 */
throw new Error(
  'provider-protocols.walk.mjs is a manifest placeholder; the executable roundtrip harness lands with the model-access journeys change.',
)

...
| 🚧 进行中 | [2026-08-28-pr216-real-canvas-merge-gate.md](plan/2026-08-28-pr216-real-canvas-merge-gate.md) | PR 216 real-canvas merge gate |
...
- 合计扫描：444 篇方案文档（docs/plan/ 与 docs/superpowers/plans/，不含 INDEX.md）

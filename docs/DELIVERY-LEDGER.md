...
| 🚧 进行中 | [2026-08-28-quality-gate-parallel-orchestration.md](superpowers/plans/2026-08-28-quality-gate-parallel-orchestration.md) | Quality Gate Parallel Orchestration Implementation Plan |
...
- 合计扫描：437 篇方案文档（docs/plan/ 与 docs/superpowers/plans/，不含 INDEX.md）

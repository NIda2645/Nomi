export const zhShotTable = {
  ...
  addColumn: '添加列', editCell: '编辑单元格', renameColumn: '重命名列', removeColumn: '删除列', generate: '生成 {{count}} 镜', running: '正在读取镜头', retry: '重新拆解', retryWithCloud: '改用云端重试', facts: { shotSize: '景别', motion: '运镜', visual: '画面', dialogue: '对白', onScreenText: '字幕', mood: '情绪' },

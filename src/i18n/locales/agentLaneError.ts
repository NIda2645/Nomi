...
export const zhAgentLaneError = {
  ...
  agent_skill_version_changed: '原技能版本已变更或无法核验，请重新选择技能后发送。',
  agent_lane_input_reference_invalid: '找不到当前对话中的原始输入，请查看历史后重新发送。',
  agent_lane_input_cancelled: '输入已停止，未发送的内容仍保留在输入框。',
  agent_lane_original_media_unavailable: '旧消息中的媒体无法完整恢复，请重新添加附件后发送。',
...
export const enAgentLaneError = {
  ...
  agent_skill_version_changed: 'The original skill version changed or cannot be verified. Select the skill again before sending.',
  agent_lane_input_reference_invalid: 'The original input is unavailable in this conversation. Check the history and send a new message.',
  agent_lane_input_cancelled: 'Input stopped. Your unsent draft is still available.',
  agent_lane_original_media_unavailable: 'The media in this old message cannot be fully restored. Attach it again before sending.',

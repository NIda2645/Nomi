export const zhGenerationCommon = {
  ...
  production: {
    ...
    gate: { approve: '批准并继续', scope: '确认范围', jobs: '涉及任务', failed: '确认没有生效' },
...
export const enGenerationCommon = {
  ...
  production: {
    ...
    gate: { approve: 'Approve and continue', scope: 'Approval scope', jobs: 'Jobs', failed: 'Approval did not take effect' },

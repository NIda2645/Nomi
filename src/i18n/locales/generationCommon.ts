export const zhGenerationCommon = {
  ...
  production: {
    ...
    description: {
      ...
      paused: '已完成的镜头与已花预算安全保留；可从断点继续，不重做不重付。',
      pausing: '正在安全停下：在途任务收尾后落停，未提交的任务不计费。',
    ...
    control: {
      ...
      cancel: '取消制作',
      cancelTitle: '取消这次制作？',
      cancelMessage: '未提交的任务不会计费；已完成的产物保留在项目里。取消后不可恢复。',
      cancelConfirm: '取消制作',
      failed: '操作失败',
    },
    runDetails: {
...
export const enGenerationCommon = {
  ...
  production: {
    ...
    description: {
      ...
      paused: 'Finished shots and spend are kept safe. Resume from the checkpoint without redoing or repaying.',
      pausing: 'Stopping safely: in-flight jobs settle first, and unsubmitted jobs are never charged.',
    ...
    control: {
      ...
      cancelMessage: 'Unsubmitted jobs are never charged, and finished artifacts stay in the project. This cannot be undone.',

export const zhGenerationCommon = {
  ...
  translator: {
    ...
    outputRule: '保留原文的换行。只输出译文本身，不要解释、不要加引号、不要加三引号。',
...
export const enGenerationCommon = {
  ...
  translator: {
    ...
    outputRule: 'Keep the original line breaks. Output only the translation, with no explanation, quotation marks, or triple quotes.',

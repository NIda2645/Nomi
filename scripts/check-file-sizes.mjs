...
const ALLOWLIST = {
  "electron/runtime.ts": 540, // …→ 550（2026-07-27）→ 543（2026-08-01 ComfyUI 请求变换接入时顺手压实 executeProfileOperation 尾段）→ 540（2026-08-11 未知状态动词根因修复，加字段的同时压实 responseParsing import）

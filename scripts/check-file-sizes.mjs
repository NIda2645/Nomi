...
const ALLOWLIST = {
  ...
  "src/workbench/generationCanvas/nodes/BaseGenerationNode.tsx": 732, // …→ 734（2026-08-09 拖动态改画布级）→ 733（2026-08-16 移除死属性）→ 732（2026-08-24 失败卡加收起钮，同处把 onRetry 的嵌套箭头体压平抵回）

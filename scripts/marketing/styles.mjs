...
.hero-product { width: min(1480px, calc(100vw - 40px)); margin: 56px auto 0; position: relative; }
...
.product-shot { margin-top: -1px; border: 1px solid var(--ink); border-radius: 0 0 6px 6px; overflow: hidden; box-shadow: var(--shadow); background: var(--white); }
.product-shot img { width: 100%; aspect-ratio: 16 / 8.8; object-fit: cover; object-position: top center; }

.cost-section { margin-top: 108px; padding: 112px 0; color: var(--white); background: var(--ink); }
...
.cost-panel { min-height: 630px; padding-top: 62px; display: grid; grid-template-columns: .7fr 1.3fr; gap: 64px; align-items: center; }
...
.cost-evidence { min-height: 480px; display: flex; align-items: center; }
.cost-evidence img { width: 100%; aspect-ratio: 16 / 9; object-fit: cover; object-position: top; border: 1px solid #4b4944; border-radius: 6px; }
...
.workflow { padding: 120px 0; background: var(--surface); border-block: 1px solid var(--rule); }
.workflow-grid { margin-top: 64px; display: grid; grid-template-columns: 330px 1fr; gap: 48px; align-items: start; }
.workflow-tabs { border-top: 1px solid var(--ink); }
.workflow-tab { width: 100%; min-height: 84px; padding: 16px 8px; display: grid; grid-template-columns: 44px 1fr; gap: 12px; align-items: center; border: 0; border-bottom: 1px solid var(--rule); background: transparent; color: var(--muted); text-align: left; cursor: pointer; }
...
.workflow-visual img { width: 100%; aspect-ratio: 16 / 9; object-fit: cover; object-position: top; border: 1px solid var(--ink); border-radius: 6px; background: var(--white); }
.workflow-caption { min-height: 66px; margin: 18px 0 0; color: var(--ink-soft); font-size: 16px; }

.agent-band { color: var(--white); background: #242c29; }
.agent-grid { width: var(--page); min-height: 680px; margin: 0 auto; padding: 88px 0; display: grid; grid-template-columns: .8fr 1.2fr; align-items: center; gap: 70px; }
...
.agent-image img { width: 100%; aspect-ratio: 16 / 9; object-fit: cover; object-position: top; border: 1px solid #5c6661; border-radius: 6px; }
...
@media (max-width: 1050px) {
  ...
  .workflow-grid { grid-template-columns: 260px 1fr; }
...
@media (max-width: 760px) {
  ...
  .product-shot img { aspect-ratio: 1.15 / 1; object-position: 52% top; }
  ...
  .workflow-tabs { min-width: 0; display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); }
